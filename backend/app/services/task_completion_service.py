...
class TaskCompletionService:
    @staticmethod
    def create_task_completion(user_id: str, task_type: str, time_spent: int, coins_received: int, xp_received: int, score: Optional[int] = None, total_questions: Optional[int] = None):
        ...
        db.task_completions.insert_one(task_completion.model_dump(by_alias=True))
        return task_completion

    @staticmethod
    def get_task_completions_by_user(user_id: str):
        task_completions = db.task_completions.find({"user_id": user_id})
