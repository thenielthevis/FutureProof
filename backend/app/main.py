...
from app.routes import user_routes, prediction_routes, avatar_routes, daily_reward_routes, health_quiz_routes, meditation_breathing_routes, physical_activity_routes, nutritional_tracking_routes, asset_routes, purchased_item_routes, quote_routes, task_completion_routes, daily_assessment_routes, owned_asset_routes, default_asset_routes
