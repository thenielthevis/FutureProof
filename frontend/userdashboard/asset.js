...
const AssetCRUD = () => {
  ...
  const handleCreateAsset = async () => {
    try {
      const newAsset = await createAsset({name, description, price, assetType, file });
      if (selectedAsset) {
        await updateAsset(selectedAsset._id, assetData);
      } else {
        ...
        {!sidebarCollapsed && (
          <View style={styles.sidebarContent}>
            ...
            <TouchableOpacity style={styles.sidebarItem} onPress={() => navigation.navigate('Home')}>
             ...
             <TouchableOpacity style={styles.sidebarItem} onPress={() => navigation.navigate('qoutes')}>
