...
const MeditationCongratulationsModal = ({ visible, onClose, rewards, exercises, timeSpent }) => {
      ...
      <Modal visible={visible} transparent={true} animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.successText}>You've successfully completed the meditation session.</Text>
...
export default MeditationCongratulationsModal;
