...
const NutritionalTrackingCongratulationsModal = ({ visible, onClose, rewards, exercises, timeSpent }) => {
      ...
      <Modal visible={visible} transparent={true} animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.successText}>You've successfully completed the nutritional tracking session. The responses you made will affect the likelihood percentage of the predicted diseases. </Text>
...
export default NutritionalTrackingCongratulationsModal;